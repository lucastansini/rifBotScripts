...
local SPELL = {name = "exevo con flam", mana = 500}		-- name -> spell to cast, mana -> min mana to cast spell
local ITEM = {id = 3449, amount = 1000, cap = 50}	-- id -> id of arrows, amount -> create only when below this amount, cap -> dont create when cap below.
