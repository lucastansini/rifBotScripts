--[[
    Script Name: 		Fast IH Healing
    Description: 		Restore health using uh rune.
    Author: 			Ascer - example
]]

local RUNE_DELAY = 1100				-- time between using rune. Default min delay on use uh is 1000ms
local HPPERC_BELOW = 60             --when your hpperc is below or equal this value
local RUNEID = 3152                 -- IH id 
