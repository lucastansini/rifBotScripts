...
local FRIENDS = {"Fezes Moles", "Cocaina", "Sushi", "Vaginolia", "Cocaine", "Pica Mole", "Sacudao", "Cocaina Jogamal", "Lat", "Dono Dalancha", "Guilherme Perez", "Cheira", "Exana Noob", "Galinha Pintuda", "GM Support", "CM Bruno"} 		-- list of friends
local BELOW = false						-- check for players below you
local ABOVE = true							-- check for player above you
